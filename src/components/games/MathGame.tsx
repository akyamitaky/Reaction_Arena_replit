...
export default function MathGame({ round, addScore, reportWrong, nextRound }: GameContext) {
      ...
      <div className="grid grid-cols-2 gap-3 w-full">
        {q.options.map(o => (
          <button
            ...
            className="p-4 rounded-xl border bg-card font-bold text-xl hover:border-primary transition-all tabular-nums"
          >
            {o}
          </button>
        ))}
