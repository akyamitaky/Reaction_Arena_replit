...
const RIDDLES = [
  {
    ...
    a: 'Keyboard',
    options: ['Keyboard', 'House', 'Car', 'Piano'],
  },
  { q: "What has hands but can't clap?", a: 'Clock', options: ['Clock', 'Doll', 'Gloves', 'Robot'] },
  {
    ...
    a: 'Echo',
    options: ['Ghost', 'Echo', 'Shadow', 'Wind'],
  },
  {
    q: 'The more you take, the more you leave behind. What am I?',
    a: 'Footsteps',
    options: ['Breath', 'Money', 'Footsteps', 'Time'],
  },
  ...
  { q: 'What gets wetter the more it dries?', a: 'Towel', options: ['Sponge', 'Paper', 'Towel', 'Soap'] },
  {
    ...
    a: 'Map',
    options: ['Globe', 'Map', 'Painting', 'Dream'],
  },
  { q: 'What has a head and a tail but no body?', a: 'Coin', options: ['Snake', 'Coin', 'Arrow', 'Nail'] },
  {
    ...
    a: 'Stamp',
    options: ['Stamp', 'Spider', 'Shadow', 'Wi-Fi'],
  },
  {
    q: "I'm tall when I'm young and short when I'm old. What am I?",
    a: 'Candle',
    options: ['Tree', 'Person', 'Candle', 'Pencil'],
  },
  ...
  { q: 'What has one eye but cannot see?', a: 'Needle', options: ['Cyclops', 'Needle', 'Storm', 'Potato'] },
  {
    ...
    a: 'Window',
    options: ['X-Ray', 'Window', 'Camera', 'Mirror'],
  },
];

export default function RiddleGame({ round, addScore, reportWrong, nextRound }: GameContext) {
